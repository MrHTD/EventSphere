                                    ...
                                    <Card.Body>
                                        ...
                                        <Form>
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control type="email" id="exampleInputemail" aria-describedby="emailHelp" name='email' onChange={GetFormValue} value={data.email} required />
                                            </Form.Group>

                                            <Button variant="primary" className="w-100 py-2 fs-4 mb-4 rounded-2" onClick={ForgetBtn}>Forget Password</Button>
                                        </Form>
                                    </Card.Body>
                                </Card>
                            </Col>
