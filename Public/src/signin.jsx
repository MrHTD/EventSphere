        ...
        axios.post("http://localhost:3000/login", data)
            .then(result => {
                ...
                if (result.data.user.role == "Organizer") {
                    // Display an error for admin SignIn attempts
                                    ...
                                    <Form>
                                        ...
                                        <div className="position-relative mt-5">
                                            <div className="d-grid gap-2 d-md-flex justify-content-sm-center justify-content-md-end">
                                                ...
                                                <Button className='w-auto px-5 fw-semibold px-3 rounded-pill' as="input" type="submit" value="SignIn" onClick={SignInBtn} />
                                            </div>
                                        </div>
                                    </Form>
                                </Col>
